...
class Wkhtmltopdf(object):
    ...
    def render_template_to_pdf(self, template_name_or_list, save=False, download=False, **context):
        ...
        wkhtmltopdfargs = "wkhtmltopdf  --disable-smart-shrinking --page-height 3in --page-width 8in --margin-top 0 --margin-bottom 0 --margin-left 0 --margin-right 0" + " " + temp_html.name + " " + temp_pdf.name 
